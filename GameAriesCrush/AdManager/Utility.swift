...
@objc class Utility:NSObject {
    ...
    static func SetupAdOnline()
    {
        ...
        {
            Adleadboot = NSUserDefaults.standardUserDefaults().objectForKey("leadboot") as! String
        ...
        //ironsource id
        if(NSUserDefaults.standardUserDefaults().objectForKey("mopubid") != nil)
        {
            MopubID = NSUserDefaults.standardUserDefaults().objectForKey("mopubid") as! String
