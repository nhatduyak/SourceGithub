...
- (void)viewDidLoad
{
    ...
    [self addTopViewWithText:@"Photograph"];
    ...
    if (![UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera]) {
        [SVProgressHUD showErrorWithStatus:@"Device does not support the camera, a sister paper to give you"];
...
#if SWITCH_SHOW_DEFAULT_IMAGE_FOR_NONE_CAMERA
    if (![UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera]) {
        [SVProgressHUD showErrorWithStatus:@"Device does not support the camera "];
        return;
    }
#endif
