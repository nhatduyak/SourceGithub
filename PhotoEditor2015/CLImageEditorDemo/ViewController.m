...
- (void)bannerViewDidLoadAd:(ADBannerView *)banner
{
    ...
    //    CGRect resizedWebView = self.view.frame;
    //    resizedWebView.size.height = self.view.frame.size.height - banner.frame.size.height;
    //    resizedWebView.origin.y = banner.frame.size.height;
    //    _GView.frame = resizedWebView;
    
    
    if (YES) {
        [UIView transitionWithView:banner
                          duration:0.4
...
-(void)pushedFacebook
{
    if([SLComposeViewController isAvailableForServiceType:SLServiceTypeFacebook])
    {
        ...
        [controller setInitialText:@"Magic EditorPicture"];
        [controller addURL:[NSURL URLWithString:@"Magic EditorPicture"]];
