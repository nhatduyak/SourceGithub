...
//    howToPlayItem.position = ccp(0, -55);
    ...
    CCLabelTTF *readme = [CCLabelTTF labelWithString:@"Drag the entire row, column, or swap adjacent whole fruit, the ranks of the three identical fruits to eliminate, you can also use props oh ~" dimensions:CGSizeMake(isPad?600:300,150) alignment:UITextAlignmentCenter fontName:@"Arial" fontSize:isPad?22:14];
...
- (void)showConfig
{
    ...
    [Utility OpenView:@"AdView1" view:app.navController];
