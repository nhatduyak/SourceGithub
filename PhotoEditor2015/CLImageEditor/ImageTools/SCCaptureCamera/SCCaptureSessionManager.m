...
- (void)switchFlashMode:(UIButton*)sender {
    ...
    if (!captureDeviceClass) {
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Message" message:@"Your device is not camera" delegate:nil cancelButtonTitle:NSLocalizedString(@"Sure", nil) otherButtonTitles: nil];
        [alert show];
        return;
    }
...
//        }
        ...
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Message" message:@"Your device is not flash function" delegate:nil cancelButtonTitle:@"Oh" otherButtonTitles: nil];
        [alert show];
    }
