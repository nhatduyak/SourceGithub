...
-(void) viewDidLoad
{
    ...
    self.bannerView.adUnitID = @"ca-app-pub-1024965356396299/1040357160";
    ...
    if (!skView.scene) {
        ...
        //self.canDisplayBannerAds=YES;
        self.interstitial = [[GADInterstitial alloc] initWithAdUnitID:@"ca-app-pub-1024965356396299/2517090363"];
...
- (void)showBanner
{
    ...
    MMAdView *banner = [[MMAdView alloc] initWithFrame:MILLENNIAL_AD_VIEW_FRAME
                                                  apid:@"205939"
