...
- (void)setupSlider
{
    ...
    [_saturationSlider setThumbImage:[UIImage imageNamed:@"saturation.png"] forState:UIControlStateNormal];
    [_saturationSlider setThumbImage:[UIImage imageNamed:@"saturation.png"] forState:UIControlStateHighlighted];
    ...
    [_brightnessSlider setThumbImage:[UIImage imageNamed:@"brightness.png"] forState:UIControlStateNormal];
    [_brightnessSlider setThumbImage:[UIImage imageNamed:@"brightness.png"] forState:UIControlStateHighlighted];
    ...
    [_contrastSlider setThumbImage:[UIImage imageNamed:@"contrast.png"] forState:UIControlStateNormal];
    [_contrastSlider setThumbImage:[UIImage imageNamed:@"contrast.png"] forState:UIControlStateHighlighted];
}
