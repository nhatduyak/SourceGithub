...
@objc class Utility:NSObject {
    ...
    static var isAd5 = false// ==>UnityAds==>chartboot
    ...
    static func SetupAdOnline()
    {
        ...
        {
            SonicIDcash = NSUserDefaults.standardUserDefaults().objectForKey("sonicid") as! String
